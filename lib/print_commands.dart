...
class PrintCommands {
  ...
  /// sets the encoding for text prints, [encoding] available is different for each printer
  appendEncoding(StarEncoding encoding) {
    this._commands.add({"appendEncoding": encoding.text});
  }

  /// run command on printer cuter, [action] available is different for each printer
  ...
  /// [absolutePosition] sets image absolute position
  ...
  /// [alignment] sets image alignment
  /// [rotation] set image rotation
  /// Set [wait] if you are using async widgets or widget that take time to fully build
  /// [logicalSize] is the size of the device the widget is made into
  /// [imageSize] is the size of image generated
  /// [textDirection] sets the textDirection
  appendBitmapWidget({
